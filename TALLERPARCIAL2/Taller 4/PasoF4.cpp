...
//Desarrolle una función que permita ingresar el valor de tres resistencias, 
//el valor de una fuente DC y una opción para determinar si se forma un circuito en serie, 
//paralelo y calcule la tensión y corriente total del circuito.
